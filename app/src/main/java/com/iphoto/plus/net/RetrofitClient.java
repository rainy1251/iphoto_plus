...
import com.iphoto.plus.BuildConfig;
...
public class RetrofitClient {
    ...
    private static final String dev_url = "http://139.224.53.155:3000";
    private static final String release_url = "https://saas.api.lightio.cc";
        ...
        return new Interceptor() {
            ...
            public Response intercept(@NonNull Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = original.newBuilder()
                        .addHeader("User-Agent", "iphoto/Android " + getVersion(UiUtils.getContext()));
    ...
    public static Interceptor errorCodeInterceptor() {
        return chain -> {
            ...
            if (contentLength != 0) {
                ...
                if (mOnErrorCalBackListener != null) {
